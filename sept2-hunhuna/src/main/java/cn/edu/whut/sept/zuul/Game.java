...
public class Game
{
    ...
    public void createRooms()
    {
        ...
        square = new Room("in the center of university");
        ...
        player = new Player("zzh", outside, 100);
        ...
        Item book = new Item("book", 5, "this is a book");
        Item flashlight = new Item("flashlight", 2, "this is a flashlight");
        Item bottled_water = new Item("bottled_water", 3, "this is a bottled_water");
        Item map = new Item("map", 1, "this is a map");
...
//    boolean sCommand(Command command){
//        boolean QUIT = false;
//        if(command.isUnknow()){
